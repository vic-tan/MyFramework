package com.vic.framework.common.utils;

import android.app.Activity;
import android.os.Build;
import android.view.WindowManager;

import com.vic.framework.common.base.ui.view.StatusBarView;
    ...
    private void windowConfig() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (TintType.PURECOLOR == mTintType) {
                ...
                StatusBarView.addStatusBarView(mActivity, CommTool.calculateColorWithAlpha(mStatusBarColor, mAlpha));
            }
            //透明底部导航栏
