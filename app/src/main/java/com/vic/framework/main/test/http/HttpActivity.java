package com.vic.framework.main.test.http;
...
import com.vic.framework.common.library.rxhttp.observer.CommonObserver;
import com.vic.framework.common.library.rxhttp.observer.StringObserver;
import com.vic.framework.common.library.rxhttp.utils.ToastUtils;
import com.vic.framework.main.test.http.api.ApiService;
...
//                            }
    ...
    private void selectPhoto(int maxSelectable) {
        Matisse.from(HttpActivity.this)
